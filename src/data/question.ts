...
export const componentList = [
  // Info
  {
    ...
    type: QuestionComponentsType.QuestionInfo, // 组件类型，不能重复，前后端统一好
    name: '问卷信息',
    isHidden: false,
    isLocked: false,
  ...
  {
    fe_id: 'c2',
    type: QuestionComponentsType.QuestionTitle, // 组件类型，不能重复，前后端统一好
    name: '标题',
    isHidden: false,
    isLocked: false,
  ...
  {
    fe_id: 'c5',
    type: QuestionComponentsType.QuestionTextarea,
    name: '多行输入',
    isHidden: false,
    isLocked: false,
